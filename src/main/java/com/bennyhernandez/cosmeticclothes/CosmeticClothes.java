package com.bennyhernandez.cosmeticclothes;
...
public class CosmeticClothes
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("cosmeticclothes", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
